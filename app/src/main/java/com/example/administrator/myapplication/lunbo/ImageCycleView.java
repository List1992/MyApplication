package com.example.administrator.myapplication.lunbo;
...
public class ImageCycleView extends LinearLayout {
     ...
     */
    public void setImageResources(ArrayList<LunboBean.Lbean> imageUrlList, ImageCycleViewListener imageCycleViewListener) {
        // 清除
    ...
    private class ImageCycleAdapter extends PagerAdapter {
         ...
         * 图片资源列表
         */
        private ArrayList<LunboBean.Lbean> mAdList = new ArrayList<LunboBean.Lbean>();
        ...
        public ImageCycleAdapter(Context context, ArrayList<LunboBean.Lbean> adList, ImageCycleViewListener imageCycleViewListener) {
...
//			return mAdList.size();
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            String imageUrl = mAdList.get(position % mAdList.size()).url;
